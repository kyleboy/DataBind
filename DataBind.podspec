...
Pod::Spec.new do |s|
  s.name             = 'DataBind'
  s.version          = '0.1.0'
  s.summary          = 'A short description of DataBind.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/iyinghui@163.com/DataBind'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'iyinghui@163.com' => 'wangyinghui@changba.com' }
  s.source           = { :git => 'https://github.com/iyinghui@163.com/DataBind.git', :tag => s.version.to_s }
